...
export const skills: Skill[] = [
  {
    ...
    items: [
      ...
      { name: "Golang", yearsOfExperience: 9, proficiencyLevel: "Expert" },
      ...
      { name: "Objective-C", yearsOfExperience: 4, proficiencyLevel: "Intermediate" },
      { name: "TypeScript", yearsOfExperience: 2, proficiencyLevel: "Intermediate" }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "Distributed Systems", yearsOfExperience: 6, proficiencyLevel: "Advanced" },
      ...
      { name: "Scalability Engineering", yearsOfExperience: 7, proficiencyLevel: "Advanced" },
      { name: "Platform Engineering", yearsOfExperience: 5, proficiencyLevel: "Advanced" },
  ...
  },
  {
    ...
    items: [
      { name: "ScyllaDB", yearsOfExperience: 4, proficiencyLevel: "Advanced" },
      { name: "Redis", yearsOfExperience: 8, proficiencyLevel: "Advanced" },
      ...
      { name: "AWS", yearsOfExperience: 5, proficiencyLevel: "Intermediate" },
      { name: "DigitalOcean", yearsOfExperience: 4, proficiencyLevel: "Intermediate" },
      { name: "CI/CD Pipeline Management", yearsOfExperience: 5, proficiencyLevel: "Advanced" }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "System Reliability", yearsOfExperience: 8, proficiencyLevel: "Expert" },
      ...
      { name: "Analytics & Instrumentation", yearsOfExperience: 5, proficiencyLevel: "Advanced" },
      { name: "A/B Testing", yearsOfExperience: 9, proficiencyLevel: "Expert" }
    ]
  },
  {
